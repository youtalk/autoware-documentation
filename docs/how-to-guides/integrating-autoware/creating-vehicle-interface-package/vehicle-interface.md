...
you need
to use [raw_vehicle_cmd_converter](https://github.com/autowarefoundation/autoware.universe/tree/v1.0/vehicle/raw_vehicle_cmd_converter) package
...
So,
you can get the calibration with using [accel_brake_map_calibrator](https://github.com/autowarefoundation/autoware.universe/tree/v1.0/vehicle/accel_brake_map_calibrator/accel_brake_map_calibrator) package.
